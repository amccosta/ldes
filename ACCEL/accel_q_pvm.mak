...
CDEBUGFLAGS = -O6 -s -mpentium # -DLOG -I/home/pvm3/pvm3/include
...
# MY_TEMPLATE_macros
#
USEROBJS = user_rt.o # the name of the calling object file
ASAOBJS = asa.o # the ASA optimization object file
EXTRAOBJS = radcalcdir2m.o lex.yy.o y.tab.o master.o
EXTRALIBS = -L/home/pvm3/pvm3/lib/LINUX -lpvm3
...
compile: $(USEROBJS) $(ASAOBJS) $(EXTRAOBJS)
	@$(CC) $(LDFLAGS) -o asa_run $(USEROBJS) $(ASAOBJS) $(EXTRAOBJS) $(EXTRALIBS) -lm
