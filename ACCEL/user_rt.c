/* $Id: user.c,v 17.19 1999/02/16 01:25:08 ingber Exp ingber $ */
...
#endif /* HAVE_ANSI */
{
  extern void rtrace_start(), rtrace_finish();
  ...
  if ((rand_seed =
    ...
    {
      Exit_USER ("main()/asa_main(): rand_seed");
      return (-2);
    }
#if ASA_LIB
...
#include <time.h>
  ...
  if ((parameter_dimension =
    ...
    {
      Exit_USER ("main()/asa_main(): parameter_dimension");
      return (-2);
    }
  if ((exit_code = (int *) calloc (1, sizeof (int))) == NULL)
    {
      Exit_USER ("main()/asa_main(): exit_code");
      return (-2);
    }
  if ((cost_flag = (int *) calloc (1, sizeof (int))) == NULL)
    {
      Exit_USER ("main()/asa_main(): cost_flag");
      return (-2);
    }
  ...
  if ((USER_OPTIONS =
    ...
    {
      Exit_USER ("main()/asa_main(): USER_DEFINES");
      return (-2);
    }
  ...
  if ((USER_OPTIONS->Asa_Data =
    ...
    {
      Exit_USER ("main()/asa_main(): USER_OPTIONS->Asa_Data");
      return (-2);
    }
  ...
  if ((USER_OPTIONS->Asa_Out_File =
    ...
    {
      Exit_USER ("main()/asa_main(): USER_OPTIONS->Asa_Out_File");
      return (-2);
    }
#endif
  ...
  *parameter_dimension = 2;
  ...
  if ((parameter_lower_bound =
    ...
    {
      Exit_USER ("main()/asa_main(): parameter_lower_bound");
      return (-2);
    }
  ...
  if ((parameter_upper_bound =
    ...
    {
      Exit_USER ("main()/asa_main(): parameter_upper_bound");
      return (-2);
    }
  ...
  if ((cost_parameters =
    ...
    {
      Exit_USER ("main()/asa_main(): cost_parameters");
      return (-2);
    }
  ...
  if ((parameter_int_real =
    ...
    {
      Exit_USER ("main()/asa_main(): parameter_int_real");
      return (-2);
    }
  ...
  if ((cost_tangents =
    ...
    {
      Exit_USER ("main()/asa_main(): cost_tangents");
      return (-2);
    }
  ...
  if (USER_OPTIONS->Curvature_0 == FALSE || USER_OPTIONS->Curvature_0 == -1)
    {
     ...
     (double *) calloc ((*parameter_dimension) *
            ...
            sizeof (double))) == NULL)
  {
    Exit_USER ("main()/asa_main(): cost_curvature");
    return (-2);
  }
    }
  else
...
#endif
{
  ...
  if ((USER_OPTIONS->User_Parameter_Temperature =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->User_Parameter_Temperature");
      return (-2);
    }
#if ASA_TEMPLATE
  for (index = 0; index < *parameter_dimension; ++index)
  ...
  if ((USER_OPTIONS->User_Cost_Temperature =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->User_Cost_Temperature");
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->User_Delta_Parameter =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->User_Delta_Parameter");
      return (-2);
    }
#if ASA_TEMPLATE
  for (index = 0; index < *parameter_dimension; ++index)
  ...
  if ((USER_OPTIONS->User_Quench_Param_Scale =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->User_Quench_Param_Scale");
      return (-2);
    }
#if ASA_TEMPLATE
  for (index = 0; index < *parameter_dimension; ++index)
  ...
  if ((USER_OPTIONS->User_Quench_Cost_Scale =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->User_Quench_Cost_Scale");
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((USER_OPTIONS->User_Temperature_Ratio =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->User_Temperature_Ratio");
      return (-2);
    }
#if ASA_TEMPLATE
  for (index = 0; index < *parameter_dimension; ++index)
  ...
  if ((USER_OPTIONS->Bias_Generated =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->Bias_Generated");
      return (-2);
    }
#endif
  ...
  if ((USER_OPTIONS->Queue_Resolution =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->Queue_Resolution");
      return (-2);
    }
  ...
  if ((USER_OPTIONS->Coarse_Resolution =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->Coarse_Resolution");
      return (-2);
    }
#if ASA_TEMPLATE
  for (index = 0; index < *parameter_dimension; ++index)
  ...
  if ((USER_OPTIONS->Multi_Grid =
    ...
    {
      Exit_USER ("initialize_parameters(): USER_OPTIONS->Multi_Grid");
      return (-2);
    }
  for (multi_index = 0; multi_index < MULTI_NUMBER; ++multi_index)
    {
  ...
  {
    Exit_USER ("initialize_parameters(): USER_OPTIONS->Multi_Params[multi_index]");
    return (-2);
  }
    }
#if ASA_TEST
...
#endif /* HAVE_ANSI */
{
  ...
  if ((recur_parameter_dimension =
       (ALLOC_INT *) calloc (1, sizeof (ALLOC_INT))) == NULL)
    {
      Exit_USER ("main()/asa_main(): recur_parameter_dimension");
      return (-2);
    }
  if ((recur_exit_code = (int *) calloc (1, sizeof (int))) == NULL)
    {
      Exit_USER ("main()/asa_main(): recur_exit_code");
      return (-2);
    }
  if ((recur_cost_flag = (int *) calloc (1, sizeof (int))) == NULL)
    {
      Exit_USER ("main()/asa_main(): recur_cost_flag");
      return (-2);
    }
  ...
  if ((RECUR_USER_OPTIONS =
       (USER_DEFINES *) calloc (1, sizeof (USER_DEFINES))) == NULL)
    {
      Exit_USER ("main()/asa_main(): RECUR_USER_OPTIONS");
      return (-2);
    }
  ...
  *recur_parameter_dimension = 2;
  ...
  if ((recur_parameter_lower_bound =
    ...
    {
      Exit_USER ("main()/asa_main(): recur_parameter_lower_bound");
      return (-2);
    }
  if ((recur_parameter_upper_bound =
    ...
    {
      Exit_USER ("main()/asa_main(): recur_parameter_upper_bound");
      return (-2);
    }
  ...
  if ((recur_cost_parameters =
    ...
    {
      Exit_USER ("main()/asa_main(): recur_cost_parameters");
      return (-2);
    }
  ...
  if ((recur_parameter_int_real =
    ...
    {
      Exit_USER ("main()/asa_main(): recur_parameter_int_real");
      return (-2);
    }
  ...
  if ((recur_cost_tangents =
    ...
    {
      Exit_USER ("main()/asa_main(): recur_cost_tangents");
      return (-2);
    }
      ...
      || RECUR_USER_OPTIONS->Curvature_0 == -1)
    {
     ...
     (double *) calloc ((*recur_parameter_dimension)
            * (*recur_parameter_dimension),
            sizeof (double))) == NULL)
  {
    Exit_USER ("main()/asa_main(): recur_cost_curvature");
    return (-2);
  }
    }
  else
  ...
  if ((RECUR_USER_OPTIONS->Asa_Data =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      Exit_USER ("main()/asa_main(): RECUR_USER_OPTIONS->Asa_Data");
      return (-2);
    }
  ...
  if ((recur_rand_seed =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_USER ("main()/asa_main(): recur_rand_seed");
      return (-2);
    }
  ...
  *recur_rand_seed = 696969;
  ...
  if ((RECUR_USER_OPTIONS->Asa_Out_File =
    ...
    {
      Exit_USER ("main()/asa_main(): RECUR_USER_OPTIONS->Asa_Out_File");
      return (-2);
    }
#if ASA_TEMPLATE_SELFOPT
...
#endif
{
  ...
  if ((RECUR_USER_OPTIONS->User_Parameter_Temperature =
       (double *) calloc (*recur_parameter_dimension,
        sizeof (double))) == NULL)
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Parameter_Temperature");
      return (-2);
    }
  for (index = 0; index < *recur_parameter_dimension; ++index)
  ...
  if ((RECUR_USER_OPTIONS->User_Cost_Temperature =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Cost_Temperature");
      return (-2);
    }
  ...
  if ((RECUR_USER_OPTIONS->User_Delta_Parameter =
       (double *) calloc (*recur_parameter_dimension,
        sizeof (double))) == NULL)
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Delta_Parameter");
      return (-2);
    }
  for (index = 0; index < *recur_parameter_dimension; ++index)
  ...
  if ((RECUR_USER_OPTIONS->User_Quench_Param_Scale =
       (double *) calloc (*recur_parameter_dimension,
        sizeof (double))) == NULL)
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Quench_Param_Scale");
      return (-2);
    }
#if ASA_TEMPLATE
  for (index = 0; index < *recur_parameter_dimension; ++index)
  ...
  if ((RECUR_USER_OPTIONS->User_Quench_Cost_Scale =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Quench_Cost_Scale");
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((RECUR_USER_OPTIONS->User_Temperature_Ratio =
       (double *) calloc (*recur_parameter_dimension,
        sizeof (double))) == NULL)
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->User_Temperature_Ratio");
      return (-2);
    }
#if ASA_TEMPLATE
  for (index = 0; index < *recur_parameter_dimension; ++index)
  ...
  if ((RECUR_USER_OPTIONS->Bias_Generated =
    ...
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->Bias_Generated");
      return (-2);
    }
#if ASA_TEMPLATE
  ...
  if ((RECUR_USER_OPTIONS->Queue_Resolution =
    ...
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->Queue_Resolution");
      return (-2);
    }
#if ASA_TEMPLATE_QUEUE
  ...
  if ((RECUR_USER_OPTIONS->Coarse_Resolution =
    ...
    {
      Exit_USER ("recur_initialize_parameters(): RECUR_USER_OPTIONS->Coarse_Resolution");
      return (-2);
    }
#if ASA_TEMPLATE_QUEUE
...
#endif
{
  ...
  if ((rand_seed =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_USER ("recur_cost_function(): rand_seed");
      return (-2);
    }
  ...
  if ((USER_OPTIONS =
       (USER_DEFINES *) calloc (1, sizeof (USER_DEFINES))) == NULL)
    {
      Exit_USER ("recur_cost_function(): USER_OPTIONS");
      return (-2);
    }
  ...
  if ((parameter_dimension =
       (ALLOC_INT *) calloc (1, sizeof (ALLOC_INT))) == NULL)
    {
      Exit_USER ("recur_cost_function(): parameter_dimension");
      return (-2);
    }
  if ((exit_code = (int *) calloc (1, sizeof (int))) == NULL)
    {
      Exit_USER ("recur_cost_function(): exit_code");
      return (-2);
    }
  if ((cost_flag = (int *) calloc (1, sizeof (int))) == NULL)
    {
      Exit_USER ("recur_cost_function(): cost_flag");
      return (-2);
    }
  ...
  *parameter_dimension = 4;
  ...
  if ((parameter_lower_bound =
    ...
    {
      Exit_USER ("recur_cost_function(): parameter_lower_bound");
      return (-2);
    }
  if ((parameter_upper_bound =
       (double *) calloc (*parameter_dimension, sizeof (double))
    ...
    {
      Exit_USER ("recur_cost_function(): parameter_upper_bound");
      return (-2);
    }
  if ((cost_parameters =
       (double *) calloc (*parameter_dimension, sizeof (double))
    ...
    {
      Exit_USER ("recur_cost_function(): cost_parameters");
      return (-2);
    }
  if ((parameter_int_real =
       (int *) calloc (*parameter_dimension, sizeof (int))
    ...
    {
      Exit_USER ("recur_cost_function(): parameter_int_real");
      return (-2);
    }
  if ((cost_tangents =
       (double *) calloc (*parameter_dimension, sizeof (double))
    ...
    {
      Exit_USER ("recur_cost_function(): cost_tangents");
      return (-2);
    }
  ...
  if (USER_OPTIONS->Curvature_0 == FALSE || USER_OPTIONS->Curvature_0 == -1)
    {
     ...
     (double *) calloc ((*parameter_dimension) *
            ...
            sizeof (double))) == NULL)
  {
    Exit_USER ("recur_cost_function(): cost_curvature");
    return (-2);
  }
    }
  else
  ...
  if ((USER_OPTIONS->Asa_Data =
    ...
    {
      Exit_USER ("recur_cost_function(): USER_OPTIONS->Asa_Data");
      return (-2);
    }
  /* Use Asa_Data[0] as flag, e.g., if used with SELF_OPTIMIZE. */
  ...
  if ((USER_OPTIONS->Asa_Out_File =
    ...
    {
      Exit_USER ("recur_cost_function(): USER_OPTIONS->Asa_Out_File");
      return (-2);
    }
#if ASA_TEMPLATE_SELFOPT
...
main ()
{
  ...
  if ((main_cost_parameters =
    ...
    {
      Exit_USER ("ASA_TEMPLATE_LIB main(): main_cost_parameters");
      return (-2);
    }
