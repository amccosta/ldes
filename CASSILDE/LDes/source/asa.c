...
#define ASA_ID \
"/* $Id: asa.c,v 17.19 1999/02/16 01:25:11 ingber Exp ingber $ */"
...
#endif /* HAVE_ANSI */
{
  ...
  if ((accepted_to_generated_ratio =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      Exit_ASA ("asa(): accepted_to_generated_ratio");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((temperature_scale_cost =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      Exit_ASA ("asa(): temperature_scale_cost");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((current_cost_temperature =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      Exit_ASA ("asa(): current_cost_temperature");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((initial_cost_temperature =
       (double *) calloc (1, sizeof (double))) == NULL)
    {
      Exit_ASA ("asa(): initial_cost_temperature");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((index_exit_v =
  ...
  if ((best_number_generated_saved =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_ASA ("asa(): best_number_generated_saved");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((recent_number_generated =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_ASA ("asa(): recent_number_generated");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((number_accepted =
  ...
  if ((recent_number_acceptances =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_ASA ("asa(): recent_number_acceptances");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((index_cost_acceptances =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_ASA ("asa(): index_cost_acceptances");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((number_acceptances_saved =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_ASA ("asa(): number_acceptances_saved");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((best_number_accepted_saved =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_ASA ("asa(): best_number_accepted_saved");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((number_invalid_generated_states =
       (LONG_INT *) calloc (1, sizeof (LONG_INT))) == NULL)
    {
      Exit_ASA ("asa(): number_invalid_generated_states");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  ...
  if ((current_generated_state =
    ...
    {
      Exit_ASA ("asa(): current_generated_state");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((last_saved_state =
  ...
  if ((best_generated_state =
       (STATE *) calloc (1, sizeof (STATE))) == NULL)
    {
      Exit_ASA ("asa(): best_generated_state");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
#if ASA_PARALLEL
  if ((gener_block_state =
    ...
    {
      Exit_ASA ("asa(): gener_block_state");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
#endif
  ...
  *curvature_flag = FALSE;
  ...
  if ((current_generated_state->parameter =
    ...
    {
      Exit_ASA ("asa(): current_generated_state->parameter");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((last_saved_state->parameter =
    ...
    {
      Exit_ASA ("asa(): last_saved_state->parameter");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((best_generated_state->parameter =
    ...
    {
      Exit_ASA ("asa(): best_generated_state->parameter");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
#if ASA_PARALLEL
  ...
  {
    Exit_ASA ("asa(): gener_block_state[index_parallel].parameter");
    *exit_status = CALLOC_FAILED;
    return (-1);
  }
    }
  ...
  if ((initial_user_parameter_temp =
    ...
    {
      Exit_ASA ("asa(): initial_user_parameter_temp");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  if ((index_parameter_generations =
    ...
    {
      Exit_ASA ("asa(): index_parameter_generations");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  ...
  if ((current_user_parameter_temp =
    ...
    {
      Exit_ASA ("asa(): current_user_parameter_temp");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
  ...
  if ((temperature_scale_parameters =
    ...
    {
      Exit_ASA ("asa(): temperature_scale_parameters");
      *exit_status = CALLOC_FAILED;
      return (-1);
    }
...
FALSE *valid_state_generated_flag\n");
  ...
  *best_number_generated_saved =
  ...
  {
    Exit_ASA ("asa(): multi_params[multi_index]");
    *exit_status = CALLOC_FAILED;
    return (-1);
  }
    }
...
#endif
{
  ...
  if ((curvature_flag =
       (int *) calloc (1, sizeof (int))) == NULL)
    {
      Exit_ASA ("asa_exit(): curvature_flag");
      *exit_status = CALLOC_FAILED;
      return (9);
    }
...
#endif /* HAVE_ANSI */
{
  ...
  if (FITLOC_PRINT != FALSE && FITLOC_PRINT != TRUE)
    {
      print_string (ptr_asa_out, "*** FITLOC_PRINT != FALSE && FITLOC_PRINT != TRUE ***");
      ++invalid;
    }
  if (MULTI_MIN != FALSE && MULTI_MIN != TRUE)
    {
      print_string (ptr_asa_out, "*** MULTI_MIN != FALSE && MULTI_MIN != TRUE ***");
      ++invalid;
    }
#if MULTI_MIN
  if (MULTI_NUMBER <= 0)
    {
      print_string (ptr_asa_out, "*** MULTI_NUMBER <= 0 ***");
      ++invalid;
    }
  VFOR (index_v)
  {
    if (((OPTIONS->Multi_Grid[index_v]) != (OPTIONS->Multi_Grid[index_v])) || OPTIONS->Multi_Grid[index_v] < 0)
      {
  print_string_index (ptr_asa_out, "*** (OPTIONS->Multi_Grid[]) != (OPTIONS->Multi_Grid[]) || OPTIONS->Multi_Grid[] < 0 ***", index_v);
  ++invalid;
      }
  }
  if (OPTIONS->Multi_Specify != 0 && OPTIONS->Multi_Specify != 1)
    {
      print_string (ptr_asa_out, "*** OPTIONS->Multi_Specify != 0 && OPTIONS->Multi_Specify != 1 ***");
      ++invalid;
    }
#endif
